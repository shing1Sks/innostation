        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="bg-black/80 backdrop-blur-lg h-[80%] w-full fixed inset-0"
            />
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              ...
              className="max-w-5xl mx-auto bg-white dark:bg-neutral-900 h-[700px]  z-[60] my-10 p-4 md:p-10 rounded-3xl font-sans relative"
            >
              <button
